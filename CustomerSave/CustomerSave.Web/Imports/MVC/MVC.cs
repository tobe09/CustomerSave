...
namespace MVC
{
    public static class Views
    {
        ...
        {
            public static class Customer_
            {
                public const string CustomerIndex = "~/Modules/Customer/Customer/CustomerIndex.cshtml";
            }

            public static class MakePayment
            {
                public const string MakePaymentIndex = "~/Modules/Customer/MakePayment/MakePaymentIndex.cshtml";
            }

            public static class Payment
            {
                public const string PaymentIndex = "~/Modules/Customer/Payment/PaymentIndex.cshtml";
            }
        }
